...
export const translations = {
  en: {
    ...
    home: {
      ...
      snapshot: "Matchday Snapshot",
      upcomingMatches: "Today and tomorrow",
  ...
  es: {
    ...
    matchBrowser: {
      ...
      tableMenu: "Tabla de todos los partidos",
      tableTime: "Hora",
      tableHome: "Local",
      tableAway: "Visitante",
      tableResult: "Resultado",
      tableScore: "Predicción",
