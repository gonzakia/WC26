...
export const translations = {
  ...
  es: {
    ...
    auth: {
      ...
      authCardCopy:
        "Si el correo es nuevo, la app creara la cuenta después de verificar el código usando el nombre de usuario que escribas aqui.",
      email: "Correo",
      ...
      noAccountCopy: "Revisa que el correo sea correcto, o registrate ahora si es una cuenta nueva.",
    ...
    home: {
      ...
      appIntro:
        "Haz predicciones de partidos del Mundial, unete a grupos privados y sigue los puntos con amigos.",
