...
import { ChevronDown, Crown, LogOut, Trash2, UserMinus, Users } from "lucide-react";
import {
  deleteGroup,
  leaveGroup,
  removeGroupMember,
  ...
  return (
    <section className="mt-8 rounded-[2rem] border border-ink/10 bg-white/80 p-8 shadow-glow backdrop-blur">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          aria-expanded={open}
          className="inline-flex items-center justify-center gap-2 rounded-full bg-ink px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800"
